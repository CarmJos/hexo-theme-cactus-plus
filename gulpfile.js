...
gulp.task('lib:firaCode', function () {
    return gulp.src([
        'node_modules/firacode/distr/fira_code.css',
        'node_modules/firacode/distr/woff2/**/*',
        'node_modules/firacode/distr/woff/**/*'
    ], {base: 'node_modules/firacode/distr'})
        .pipe(gulp.dest('./source/lib/firacode'))
})

gulp.task('lib:notoSansSC', function () {
    return gulp.src([
        'node_modules/@fontsource/noto-sans-sc/400.css',
        'node_modules/@fontsource/noto-sans-sc/files/*-400-*'
    ], {base: 'node_modules/@fontsource/noto-sans-sc'})
        .pipe(gulp.dest('./source/lib/noto-sans-sc'))
})

gulp.task('lib:hint', function () {
    return gulp.src(['node_modules/hint.css/hint.min.css'])
        .pipe(gulp.dest('./source/lib/hint'))
})
...
gulp.task('lib', gulp.series(
    ...
    'lib:vazirFont', 'lib:justifiedGallery', 'lib:clipboard',
    'lib:firaCode', 'lib:notoSansSC', 'lib:hint'));
